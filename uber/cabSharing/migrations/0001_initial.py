# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-07-10 17:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(error_messages={b'unique': b'this phone number already being taken'}, max_length=10, unique=True)),
                ('email', models.EmailField(error_messages={b'unique': b'this email already being taken'}, max_length=100, unique=True)),
                ...
                ('status', models.CharField(default=b'AVAILABLE', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Request',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(default=b'INITIATED', max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='Ride',
            fields=[
                ...
                ('start_address', models.CharField(max_length=100)),
                ('end_address', models.CharField(max_length=100)),
                ('status', models.CharField(default=b'assigned', max_length=50)),
